...
public class articolo {
	 ...
	 * 
	 * Controlla che la categoria sia contentua nell'arrayList di categoria della
	 ...
	 * 
	 * @exception articoloException viene generata quando la categoria non &egrave;
	 *                              presente nelle categorie esistenti.
	 */
	...
	/**
	 * Lo scopo del metodo toString &egrave; quello di poter stampare il contenuto
	 * di ogni articolo in un certo formato. Se il nome è più corto di 8 caratteri aggiungo un tab
	 * per sistemare la visualizzazione delle liste di articoli.
	 * 
	 ...
	 * 
	 * Invoca il costruttore con i paramentri nome, DEFAULT_QTY (1), costo,
	 * DEFAULT_CATEGORY ("Non categorizzati")
	 * 
	 * @param nome  il nome dell'articolo
	 * @param costo il costo dell'articolo
	 * 
	 ...
	 * 
	 * Invoca il costruttore con i paramentri nome, qty, costo, DEFAULT_CATEGORY
	 * ("Non categorizzati")
	 * 
	 * @param nome  il nome dell'articolo
	 * @param qty   la quantita' di articoli
	 ...
	 * Costruttore della classe articolo nel caso manchi la categoria.
	 * 
	 * Invoca il costruttore con i paramentri nome, DEFAULT_CATEGORY (1), costo,
	 * categoria
	 * 
	 * @param nome      il nome dell'articolo
	 * @param costo     il costo dell'articolo
	...
	/**
	 * Lo scopo del metodo getNome &egrave; quello di restituire il nome
	 * dell'articolo.
	 * 
	...
	/**
	 * Lo scopo del metodo getQty &egrave; quello di restituire la quantita'
	 * dell'articolo.
	 * 
	...
	/**
	 * Lo scopo del metodo setQty &egrave; quello di modificare la quantita'
	 * dell'articolo.
	 * 
	 */
	...
	/**
	 * Lo scopo del metodo getCategoria &egrave; quello di restituire la categoria
	 * dell'articolo.
	 * 
	...
	/**
	 * Lo scopo del metodo setCategoria &egrave; quello di modificare la categoria
	 * dell'articolo.
	 * 
	 * Controlla se la categoria è presente nelle categorie esistenti
	 * 
	 * @param categoria la nuova categoria dell'articolo
	 * @throws articoloException viene generata nel caso in cui la categoria non
	 *                           dovesse esistere
	 */
	...
	/**
	 * Lo scopo del metodo getCosto &egrave; quello di restituire il costo
	 * dell'articolo.
	 * 
	...
	/**
	 * Lo scopo del metodo setCosto &egrave; quello di modificare il costo
	 * dell'articolo.
	 * 
